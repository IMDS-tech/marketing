...
'tiktok-ads':{authorizeUrl:'https://ads.tiktok.com/marketing_api/auth',tokenUrl:'https://business-api.tiktok.com/open_api/v1.3/oauth2/access_token/',clientId:config.TIKTOK_CLIENT_ID,clientSecret:config.TIKTOK_CLIENT_SECRET,scopes:[]}}
