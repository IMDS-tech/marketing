...
const implementedRoutes:Record<string,(clientId:string)=>string>={
  authentication:()=>'/platform/authentication',workspace:()=>'/platform/workspace','client-directory':()=>'/','integration-catalog':()=>'/data','connection-manager':()=>'/data/connections','agency-connections':()=>'/data/agency-connections','data-source-management':clientId=>`/client/${clientId}/data`,'integration-schema':()=>'/data/schema','sync-health':()=>'/data/sync-health','dashboard-directory':clientId=>`/client/${clientId}/dashboards`,campaigns:clientId=>`/client/${clientId}/meta-ads/campaigns`,'report-directory':()=>'/reports','rollup-dashboards':()=>'/rollups','kpi-management':()=>'/kpis','export-center':()=>'/exports',
};
