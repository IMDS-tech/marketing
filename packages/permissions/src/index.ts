export const permissions={clientsRead:'clients.read',clientsManage:'clients.manage',reportsRead:'reports.read',reportsManage:'reports.manage',integrationsRead:'integrations.read',integrationsManage:'integrations.manage',agencyManage:'agency.manage'} as const;
